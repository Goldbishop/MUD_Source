...
//Remove this and replace with a timed noloot
    ...
    void do_look( CHAR_DATA *ch, char *argument )
   {
      ...
      if ( ch->position == POS_SLEEPING )
      {
         send_to_char( "You can't see anything, except the back of your eye-lids, you're sleeping!\n\r", ch );
         return;
      }
    ...
    void do_whois (CHAR_DATA *ch, char *argument)
   {
      ...
      for (d = descriptor_list; d != NULL; d = d->next)
      {
         ...
         /* work out the printing */
            ...
            switch(wch->level)
            {
               case MAX_LEVEL - 0 : class = "IMP"; 	
                  break;
               case MAX_LEVEL - 1 : class = "CRE";	
                  break;
               case MAX_LEVEL - 2 : class = "SUP";	
                  break;
               case MAX_LEVEL - 3 : class = "DEI";	
                  break;
               case MAX_LEVEL - 4 : class = "GOD";	
                  break;
               case MAX_LEVEL - 5 : class = "IMM";	
                  break;
               case MAX_LEVEL - 6 : class = "DEM";	
                  break;
               case MAX_LEVEL - 7 : class = "ANG";	
                  break;
               case MAX_LEVEL - 8 : class = "AVA";	
                  break;
            }
     ...
     */
      ...
      for ( ;; )
      {
         ...
         if ( is_number( arg ) )
         {
            switch ( ++nNumber )
            {
               case 1: iLevelLower = atoi( arg ); 
                  break;
               case 2: iLevelUpper = atoi( arg ); 
                  break;
               default:
