...
const byte saving_throws[4][5][25] = {
  {
      {16, 14, 14, 14, 14, 14, 13, 13, 13, 13, 13, 11, 11, 11, 11, 11, 10, 10,
          10, 10, 10, 8, 6, 4, 0},
      {13, 11, 11, 11, 11, 11, 9, 9, 9, 9, 9, 7, 7, 7, 7, 7, 5, 5, 5, 5, 5, 3,
          2, 1, 0},
      {15, 13, 13, 13, 13, 13, 11, 11, 11, 11, 11, 9, 9, 9, 9, 9, 7, 7, 7, 7,
          7, 5, 4, 2, 0},
      {17, 15, 15, 15, 15, 15, 13, 13, 13, 13, 13, 11, 11, 11, 11, 11, 9, 9,
          9, 9, 9, 7, 5, 3, 0},
      {14, 12, 12, 12, 12, 12, 10, 10, 10, 10, 10, 8, 8, 8, 8, 8, 6, 6, 6, 6,
          6, 4, 3, 2, 0}
    }, {
      {11, 10, 10, 10, 9, 9, 9, 7, 7, 7, 6, 6, 6, 5, 5, 5, 4, 4, 4, 2, 2, 2,
          2, 1, 0},
      {16, 14, 14, 14, 13, 13, 13, 11, 11, 11, 10, 10, 10, 9, 9, 9, 8, 8, 8,
          6, 6, 5, 4, 3, 0},
      {15, 13, 13, 13, 12, 12, 12, 10, 10, 10, 9, 9, 9, 8, 8, 8, 7, 7, 7, 5,
          5, 4, 3, 2, 0},
      {18, 16, 16, 16, 15, 15, 15, 13, 13, 13, 12, 12, 12, 11, 11, 11, 10, 10,
          10, 8, 8, 7, 6, 5, 0},
      {17, 15, 15, 15, 14, 14, 14, 12, 12, 12, 11, 11, 11, 10, 10, 10, 9, 9,
          9, 7, 7, 6, 5, 4, 0}
    }, {
      {15, 13, 13, 13, 13, 12, 12, 12, 12, 11, 11, 11, 11, 10, 10, 10, 10, 9,
          9, 9, 9, 8, 7, 6, 0},
      {16, 14, 14, 14, 14, 12, 12, 12, 12, 10, 10, 10, 10, 8, 8, 8, 8, 6, 6,
          6, 6, 4, 3, 2, 0},
      {14, 12, 12, 12, 12, 11, 11, 11, 11, 10, 10, 10, 10, 9, 9, 9, 9, 8, 8,
          8, 8, 7, 5, 3, 0},
      {18, 16, 16, 16, 16, 15, 15, 15, 15, 14, 14, 14, 14, 13, 13, 13, 13, 12,
          12, 12, 12, 11, 9, 5, 0},
      {17, 15, 15, 15, 15, 13, 13, 13, 13, 11, 11, 11, 11, 9, 9, 9, 9, 7, 7,
          7, 7, 5, 3, 1, 0}
    }, {
      {16, 14, 14, 13, 13, 11, 11, 10, 10, 8, 8, 7, 7, 5, 5, 4, 4, 3, 3, 3, 3,
          2, 2, 1, 0},
      {18, 16, 16, 15, 15, 13, 13, 12, 12, 10, 10, 9, 9, 7, 7, 6, 6, 5, 5, 5,
          5, 4, 3, 2, 0},
      {17, 15, 15, 14, 14, 12, 12, 11, 11, 9, 9, 8, 8, 6, 6, 5, 5, 4, 4, 4, 4,
          3, 2, 1, 0},
      {20, 17, 17, 16, 16, 13, 13, 12, 12, 9, 9, 8, 8, 5, 5, 4, 4, 4, 4, 4, 4,
          3, 2, 1, 0},
      {19, 17, 17, 16, 16, 14, 14, 13, 13, 11, 11, 10, 10, 8, 8, 7, 7, 6, 6,
          6, 6, 4, 2, 1, 0}
    }
};
...
void clone_char (struct char_data *ch)
{
  ...
  for (i = 0; i < 5; i++)
    clone->specials.apply_saving_throw[i] =
      ch->specials.apply_saving_throw[i];
  ...
  GET_NAME (clone) = str_dup (GET_NAME (ch));
...
void assign_spell_pointers (void)
{
  ...
  SPELLO (23, 12, POSITION_FIGHTING, 21, 7, 15, TAR_IGNORE, cast_earthquake);
  ...
  SPELLO (1, 12, POSITION_STANDING, 5, 1, 5, TAR_CHAR_ROOM, cast_armor);

  SPELLO (2, 12, POSITION_FIGHTING, 8, 21, 35, TAR_SELF_ONLY, cast_teleport);

  SPELLO (3, 12, POSITION_STANDING, 21, 5, 5,
    TAR_OBJ_INV | TAR_OBJ_EQUIP | TAR_CHAR_ROOM, cast_bless);

  SPELLO (4, 12, POSITION_STANDING, 8, 6, 5, TAR_CHAR_ROOM, cast_blindness);

  SPELLO (7, 12, POSITION_STANDING, 14, 21, 5,
    TAR_CHAR_ROOM | TAR_SELF_NONO, cast_charm_person);

  SPELLO (9, 12, POSITION_STANDING, 15, 21, 40, TAR_CHAR_ROOM, cast_clone);

  SPELLO (11, 12, POSITION_STANDING, 10, 13, 25,
    TAR_IGNORE, cast_control_weather);

  SPELLO (12, 12, POSITION_STANDING, 21, 3, 5, TAR_IGNORE, cast_create_food);
  ...
  SPELLO (28, 12, POSITION_FIGHTING, 21, 14, 50, TAR_CHAR_ROOM, cast_heal);
  ...
  SPELLO (38, 12, POSITION_STANDING, 14, 21, 15, TAR_CHAR_ROOM, cast_sleep);

  SPELLO (39, 12, POSITION_STANDING, 7, 21, 20,
    TAR_CHAR_ROOM | TAR_SELF_ONLY, cast_strength);

  SPELLO (40, 12, POSITION_STANDING, 21, 8, 50, TAR_CHAR_WORLD, cast_summon);
